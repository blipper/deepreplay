...
class Replay(object):
    ...
    def __init__(self, replay_filename, group_name, model_filename=''):
        ...
        self._z_tensors = [tensorflow.identity(self.model.inputs)] + list(filter(lambda t: t is not None,
        ...
        self._activation_tensors = [tensorflow.identity(self.model.inputs)] + [self.model.layers[i].output for i in __act_layers]
